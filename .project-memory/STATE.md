...
- Anatomy Ch7 Q11–Q21 is now a bounded approved-rollout candidate on `feature/marrow-explanations-anatomy-20260923-source-export-r2`, based on canonical `cb3f44b`. Source audit and static validation passed; browser, exact-head Engineering/full CI, and canonical reconciliation remain pending. The earlier candidate-only build fix passed full CI `35880725166` and Engineering `35880772345` at `2507aeb`. Handoff: `.project-memory/AUTOMATION_HANDOFF_ANATOMY_EXPLANATION_CH07_Q011_Q021_2026-09-23.md`.
