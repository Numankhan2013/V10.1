...
- Build and verify the Browser/PWA Back warning, then share a Cloudflare preview that visibly exercises it. The packaged Android candidate remains separate. Then prioritize source-backed explanations in the current three subjects through a bounded batch on the exact canonical Marrow head. Do not promote production or claim physical device acceptance from CI.
