...
- Share the packaged Android candidate for physical Back-button review. Then prioritize source-backed explanations in the current three subjects through a bounded batch on the exact canonical Marrow head. Tracker UI polish and new subject integration remain later work. Do not promote production or claim physical device acceptance from CI.
