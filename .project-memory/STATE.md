...
- Finish Android Back confirmation through full packaged-app/emulator verification and share its replacement preview. Then prioritize source-backed explanations in the current three subjects through a bounded batch on the exact canonical Marrow head. Tracker UI polish and new subject integration remain later work. Do not promote production or claim physical device acceptance from CI.
