...
Do not use the historical 2,115-question Phase-A denominator for completeness, inventory, coverage, or next-source-order decisions.
...
- Read `docs/MARROW_EXPLANATION_AUTOMATION_RUNBOOK.md` from `main`, then this policy.
