...
def main() -> None:
    ...
    assert batch["scope"]["canonicalBaseSha"] == "daa48f78ca208846f8be8781c64b8a297b5ab98d"
    ...
    for qid in EXPECTED_IDS:
        ...
        # Ch6 predates full-corpus consolidation; stable-ID source ownership must
        # be byte-for-byte equivalent to the previously audited Phase-A record.
