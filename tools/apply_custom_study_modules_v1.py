...
.nk-module-select-tools{flex-wrap:wrap}.nk-module-source-filters{grid-template-columns:repeat(2,minmax(0,1fr))}
.nk-module-scope-summary{display:grid;gap:10px;margin-bottom:14px;padding:13px;border:1px solid #dce4f6;border-radius:12px;background:#f7f9ff}.nk-module-scope-summary strong{font-size:11px;color:var(--nk114-ink)}.nk-module-scope-summary p{margin:5px 0;color:#5b6482;font-size:9px;line-height:1.45}.nk-module-scope-summary small{color:#3d5f9e;font-size:9px;font-weight:750}.nk-module-scope-actions{display:flex;flex-wrap:wrap;gap:7px}.nk-module-scope-actions button{min-height:34px;padding:0 10px;border:1px solid #bfcbea;border-radius:8px;background:#fff;color:#3d5f9e;font-size:9px;font-weight:800}
.nk-module-builder.is-topics{max-width:820px}.nk-module-builder.is-topics .nk-module-builder-card{padding:0;border:0;background:transparent;min-height:0}.nk-module-topic-intro{display:flex;justify-content:space-between;align-items:baseline;gap:12px;margin:3px 0 14px}.nk-module-topic-intro strong{font-size:14px;line-height:1.4}.nk-module-topic-intro span{color:var(--nk114-indigo);font-size:12px;font-weight:800;white-space:nowrap}.nk-module-topic-search{display:block;margin-bottom:12px}.nk-module-topic-search>span{display:block;margin-bottom:7px;color:#55617c;font-size:12px;font-weight:800}.nk-module-topic-search input{width:100%;height:50px;padding:0 15px;border:1px solid #cdd5e6;border-radius:12px;background:#fff;color:var(--nk114-ink);font-size:14px;outline:none}.nk-module-topic-search input:focus{border-color:var(--nk114-indigo);box-shadow:0 0 0 3px #e9ecff}.nk-module-select-tools{display:flex;align-items:stretch;flex-wrap:wrap;gap:8px;margin:0 0 18px}.nk-module-select-tools button{min-height:42px;padding:0 14px;border:1px solid #d9deeb;border-radius:10px;background:#fff;color:#3b4d7d;font-size:12px;font-weight:750}.nk-module-select-tools button:hover,.nk-module-group-action:hover{background:#f3f5ff}.nk-module-search-status{min-height:0;margin:0 0 4px;color:#596784;font-size:12px;font-weight:700}.nk-module-search-status:empty{display:none}.nk-module-topic-groups{max-height:none;overflow:visible;border:0;border-radius:0;display:grid;gap:16px}.nk-module-topic-group{width:100%;min-width:0;border:1px solid #dfe4ef;border-radius:15px;background:#fff;overflow:hidden}.nk-module-topic-group+.nk-module-topic-group{border-top:1px solid #dfe4ef}.nk-module-topic-group>header{position:static;min-height:68px;padding:11px 14px;background:#f7f8fc;display:grid;grid-template-columns:34px minmax(0,1fr) auto;gap:11px}.nk-module-topic-group>header>span{width:34px;height:34px;border-radius:10px;background:#eef1f8;color:#4e6094}.nk-module-topic-group header strong{font-size:14px;line-height:1.25}.nk-module-topic-group header small{margin-top:3px;font-size:11px}.nk-module-group-action{min-height:42px;padding:0 12px;border:1px solid #d5dced;border-radius:9px;background:#fff;color:var(--nk114-indigo);font-size:11px;font-weight:800}.nk-module-topic-list{width:100%}.nk-module-topic{width:100%;min-height:68px;padding:12px 15px;grid-template-columns:minmax(0,1fr) 28px;gap:12px}.nk-module-topic strong{font-size:14px;line-height:1.3}.nk-module-topic small{margin-top:5px;font-size:11px;line-height:1.3}.nk-module-topic:hover{background:#f8f9ff}.nk-module-topic.is-selected{background:#f2f5ff}.nk-module-topic.is-selected strong{color:#263f86}.nk-module-check{width:26px;height:26px;border-radius:8px}.nk-module-topic:focus-visible,.nk-module-select-tools button:focus-visible,.nk-module-group-action:focus-visible,.nk-module-topic-actions button:focus-visible{outline:3px solid #abbaf3;outline-offset:-3px}.nk-module-topic[hidden],.nk-module-topic-group[hidden],.nk-module-search-empty[hidden]{display:none!important}.nk-module-search-empty{margin:16px 0;padding:22px;border:1px dashed #cbd3e5;border-radius:12px;background:#fff;color:#596784;text-align:center;font-size:13px}.nk-module-topic-actions{position:sticky;bottom:76px;z-index:35;grid-template-columns:1fr auto;min-height:72px;margin:16px -10px 0;padding:10px;border:1px solid #dfe4ef;border-radius:14px;background:rgba(255,255,255,.97);box-shadow:0 -8px 26px rgba(29,38,78,.09);backdrop-filter:blur(8px)}.nk-module-topic-actions>span{color:#4d5977;font-size:12px;font-weight:800}.nk-module-topic-actions>button{min-height:48px;font-size:12px}
@media(max-width:620px){.nk-module-topic-intro{align-items:flex-start;flex-direction:column;gap:3px}.nk-module-topic-search input{height:48px}.nk-module-select-tools{display:grid;grid-template-columns:repeat(3,minmax(0,1fr));gap:6px}.nk-module-select-tools button{padding:4px 5px;font-size:10.5px;line-height:1.15}.nk-module-topic-group>header{grid-template-columns:30px minmax(0,1fr) auto;padding:10px;gap:8px}.nk-module-topic-group>header>span{width:30px;height:30px}.nk-module-topic-group header strong{font-size:12px}.nk-module-group-action{min-height:40px;padding:0 8px;font-size:10px}.nk-module-topic{min-height:70px;padding:12px}.nk-module-topic strong{font-size:13.5px}.nk-module-topic-actions{bottom:76px;grid-template-columns:1fr auto;margin:15px -10px 0;padding:9px 10px}.nk-module-topic-actions>span{display:block;font-size:11px}.nk-module-topic-actions>button{width:auto;min-height:48px;padding:0 13px;font-size:11px}}
@media(max-width:350px){.nk-module-topic-group>header{grid-template-columns:28px minmax(0,1fr)}.nk-module-topic-group>header>span{width:28px;height:28px}.nk-module-group-action{grid-column:2;justify-self:start}.nk-module-topic-actions>button{padding:0 10px}}
.nk-module-builder .nk-module-subject strong{font-size:14px}.nk-module-builder .nk-module-subject small{font-size:11px;line-height:1.4}.nk-module-builder .nk-module-scope-summary strong{font-size:13px}.nk-module-builder .nk-module-scope-summary p,.nk-module-builder .nk-module-scope-summary small{font-size:11px;line-height:1.45}.nk-module-builder .nk-module-scope-actions button{min-height:42px;font-size:11px}.nk-module-builder .nk-module-pool-grid button{min-height:78px;padding:13px}.nk-module-builder .nk-module-pool-grid strong{font-size:13px}.nk-module-builder .nk-module-pool-grid small{font-size:11px;line-height:1.4}.nk-module-builder .nk-module-count-block>strong{font-size:13px}.nk-module-builder .nk-module-count-presets button{min-height:44px;font-size:12px}.nk-module-builder .nk-module-count-block label,.nk-module-builder .nk-module-name{font-size:12px}.nk-module-builder .nk-module-count-block input,.nk-module-builder .nk-module-name input{font-size:14px}.nk-module-builder .nk-module-count-block p{font-size:11px;line-height:1.4}.nk-module-builder .nk-module-review-card small{font-size:11px}.nk-module-builder .nk-module-review-card strong{font-size:14px;line-height:1.35}.nk-module-builder .nk-module-review-card p{font-size:11px}.nk-module-builder .nk-module-builder-actions:not(.nk-module-topic-actions){display:flex;justify-content:flex-end}.nk-module-builder .nk-module-builder-actions:not(.nk-module-topic-actions)>button{min-width:160px;font-size:12px}.nk-module-builder .nk-module-final-actions button{min-height:48px;font-size:12px}
@media(max-width:620px){.nk-module-builder .nk-module-builder-actions:not(.nk-module-topic-actions)>button,.nk-module-builder .nk-module-final-actions{width:100%}.nk-module-builder .nk-module-final-actions{display:grid;grid-template-columns:1fr 1fr}}
.nk-module-builder.is-topics .nk-module-topic-groups{grid-template-columns:minmax(0,1fr)}.nk-module-topic-group .nk-module-group-action{font-size:11px}.nk-module-topic-actions{position:static;margin:16px 0 0}
@media(max-width:620px){body:has(.nk-module-builder.is-topics) .page{padding-bottom:190px!important}.nk-module-builder.is-topics .nk-module-stepper{display:none}.nk-module-topic-actions{position:fixed;bottom:76px;left:50%;width:calc(100% - 28px);max-width:760px;min-height:72px;margin:0;transform:translateX(-50%);box-sizing:border-box}.nk-module-topic-group .nk-module-group-action{font-size:10px}}
@media(max-width:350px){.nk-module-builder.is-topics .nk-page-head p,.nk-module-builder.is-topics .nk-module-topic-intro{display:none}.nk-module-topic-actions>span{font-size:10px;white-space:nowrap}}
</style>'''
