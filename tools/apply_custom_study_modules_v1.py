...
.nk-module-topic-groups{grid-template-columns:minmax(0,1fr)}.nk-module-topic-group .nk-module-group-action{font-size:11px}.nk-module-topic-actions{position:static;margin:16px 0 0}
