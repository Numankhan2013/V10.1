...
for(const id of ['physiology-1-13','physiology-4-8','physiology-6-2','physiology-24-10']){
...
assert(tableCount>=5,'expected matching/list questions to use semantic tables');
