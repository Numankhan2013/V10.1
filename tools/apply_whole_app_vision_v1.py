...
TOPICS = r'''function nkTopicSection(chapter) {
    ...
    const ranges={anatomy:[[1,6,'Neuroanatomy'],[7,15,'Head & Neck'],[16,21,'Upper Limb'],[22,25,'Lower Limb'],[26,29,'Thorax'],[30,36,'Abdomen'],[37,41,'Pelvis & Perineum'],[42,45,'General Embryology'],[46,48,'Histology'],[49,50,'Back']],physiology:[[1,8,'Neurophysiology'],[9,12,'General, Nerve & Muscle'],[13,17,'Cardiovascular System'],[18,19,'Blood'],[20,23,'Renal System'],[24,29,'Respiratory System'],[30,33,'Gastrointestinal System'],[34,37,'Endocrine System'],[38,38,'Reproductive System']],biochemistry:[[1,7,'Carbohydrate Metabolism'],[8,12,'Lipid Metabolism'],[13,16,'Proteins & Amino Acids'],[17,21,'Molecular Biology'],[22,23,'Enzymes'],[24,24,'Heme Metabolism'],[25,28,'Vitamins & Nutrition']]};
    if((typeof activeBank!=='undefined'&&activeBank==='Marrow')||String(chapter?.id||'').startsWith('marrow-')) return subject.includes('physiology')?'General Physiology':'General Embryology';
    const key=subject.includes('anatomy')?'anatomy':subject.includes('physiology')?'physiology':'biochemistry';
    return (ranges[key].find(([a,b])=>n>=a&&n<=b)||[])[2]||'Needs classification review';
  }
  function topics() {
