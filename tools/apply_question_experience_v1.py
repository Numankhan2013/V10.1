...
.nk-v113-question .option-list{display:grid;gap:10px!important}.nk-v113-question .option{width:100%;min-height:62px!important;display:grid!important;grid-template-columns:38px minmax(0,1fr) 34px!important;align-items:center!important;gap:10px!important;padding:10px 12px!important;border:1px solid #dfe3ec!important;border-radius:13px!important;background:#fff!important;color:#11183d!important;box-shadow:none!important;text-align:left!important;opacity:1!important}.nk-v113-question .option:hover{transform:none!important}.nk-v113-question .option:active{transform:scale(.995)}
