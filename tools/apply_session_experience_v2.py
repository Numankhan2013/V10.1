...
.nk-v114-session .option-list{display:grid!important;gap:10px!important}.nk-v114-session .option{width:100%;min-height:60px!important;display:grid!important;grid-template-columns:38px minmax(0,1fr)!important;align-items:center!important;gap:10px!important;padding:10px 12px!important;border:1px solid #dfe3ec!important;border-radius:13px!important;background:#fff!important;color:#11183d!important;box-shadow:none!important;text-align:left!important;opacity:1!important}.nk-v114-session button.option:hover{transform:none!important}.nk-v114-session button.option:active{transform:scale(.995)}
...
@media(max-width:520px){.nk-session-progress{margin-bottom:18px}.nk-question-context{display:grid;box-sizing:border-box;width:100%;grid-template-columns:32px minmax(0,1fr);gap:5px 8px;margin-bottom:18px}.nk-question-context>i{display:none}.nk-question-context>span:last-child{grid-column:1/-1;min-width:0;overflow-wrap:anywhere}.nk-v114-session .question-text{font-size:20px!important}.nk-v114-session .option{min-height:58px!important;padding:9px 11px!important}.nk-key-takeaway{padding:14px 12px}.nk-session-footer{padding-left:12px!important;padding-right:12px!important}.qb-nav-grid{gap:7px!important}}
</style>'''
