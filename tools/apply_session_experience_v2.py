...
@media(max-width:520px){.nk-session-progress{margin-bottom:18px}.nk-v114-session .question-text{font-size:20px!important}.nk-v114-session .option{min-height:58px!important;padding:9px 11px!important}.nk-key-takeaway{padding:14px 12px}.nk-session-footer{padding-left:12px!important;padding-right:12px!important}.qb-nav-grid{gap:7px!important}}
</style>'''
