...
def main():
    ...
    assert len(all_expanded)==2376 and len({q['id'] for q in all_expanded})==2376
    ...
    if args.data_only:
        print('MARROW_DATA_OK anatomy=819/48 biochemistry=543/26 physiology=1014/43 total=2376 pilot_enhanced=142 rationales=426 repaired=3');return
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for i,src in enumerate(scripts):
            ...
            checked+=1
    print(f'MARROW_BANK_PILOT_TEST_OK anatomy=819/48 biochemistry=543/26 physiology=1014/43 total=2376 enhanced_subset=142 rationales=426 phys_clean_subset=80 micro_concision=on fsrs_dock=preserved scripts={checked}')
