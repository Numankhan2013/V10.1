...
def main():
    ...
    if args.data_only:
        print('MARROW_DATA_OK questions=62 topics=4 repaired=3');return
    s=HTML.read_text(encoding='utf-8')
    required=['NK_MARROW_BANK_PILOT_V1_START','nk-marrow-bank-pilot-v1','function nkBankRecords(name)','function openBank(name,bank)','function bankPage(name)',"route.page==='banks'",'Detailed explanation','Structured text','function nkRenderMarrowExplanation(q)',"q.bank==='Marrow'",'qbank_active_bank_v1','marrow__ANAT_CH01_Q001']
    ...
    with tempfile.TemporaryDirectory() as td:
        ...
        for i,src in enumerate(scripts):
            ...
            checked+=1
    print(f'MARROW_BANK_PILOT_TEST_OK questions=62 topics=4 scripts={checked}')
