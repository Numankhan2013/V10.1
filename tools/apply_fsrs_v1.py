...
.nk-fsrs-settings-note{font-size:12px;line-height:1.6;color:#8d7a9d;padding:0 5px}.nk-fsrs-settings-save{position:fixed!important;z-index:90;bottom:calc(86px + env(safe-area-inset-bottom));left:14px;right:14px;max-width:712px;margin:auto;background:#f7f2fff5;border:1px solid #fff;border-radius:19px;padding:12px 14px;box-shadow:0 4px 28px #79579d30;backdrop-filter:blur(12px)}
...
.page:has(.nk-fsrs-settings){animation:none!important;transform:none!important}
