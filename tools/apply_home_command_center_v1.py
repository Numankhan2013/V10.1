...
def transform(source: str) -> str:
    ...
    quick_study = quick_study.replace('From the current question bank', "${fmtNum(nkQuickStudyCount('wrong'))} missed · all banks · edit scope", 1)
    quick_study = quick_study.replace('From the current question bank', "${fmtNum(nkQuickStudyCount('unattempted'))} unseen · all banks · edit scope", 1)
    quick_study = quick_study.replace('source-labelled questions</small>', 'source-labelled PYQs · all subjects · edit scope</small>')
