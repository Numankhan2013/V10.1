...
@media(max-width:360px){.nk-session-review-grid{grid-template-columns:repeat(4,minmax(0,1fr))}.nk-session-review-q small{font-size:9px}}
</style>
'''
