#!/usr/bin/env python3
"""Stable-ID browser regression for Anatomy Ch7 Q10 enhanced explanation rendering."""
...
STABLE_ID = "marrow__ANAT_CH07_Q010"
...
def main() -> None:
    ...
    with socketserver.TCPServer(("127.0.0.1", 0), handler) as server:
        ...
        with sync_playwright() as p:
            ...
            for marker in ("key takeaway", "omphalocele", "membranous sac", "gastroschisis", "failure of midgut return"):
            ...
            page.screenshot(path=str(OUT / "anatomy-ch07-q010-stable-id.png"), full_page=True)
            browser.close()
        server.shutdown()
    print(f"MARROW_ANATOMY_CH07_Q010_BROWSER_OK stable_id={STABLE_ID} rationales=3 source_note=preserved")
