  ...
  function nkFsrsSessionAttemptSource(s){const origin=String(s?.originRoute||s?.context||'');if(origin==='fsrs'||origin==='spaced-review')return'fsrs-review';return s?.studyModuleId?'study-module':'practice';}
